...
Once you clone the project locally use [captain](https://github.com/davin-bao/docker-rabbitmq-cluster) to build the image or do with docker:

```
docker build -t davinbao/rabbitmq-cluster .
```
...
```
rabbit1:
  image: davinbao/rabbitmq-cluster
  hostname: rabbit1
  environment:
